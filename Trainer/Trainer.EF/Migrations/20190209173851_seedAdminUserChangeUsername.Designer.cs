...
namespace Trainer.EF.Migrations
{
    ...
    [Migration("20190209173851_seedAdminUserChangeUsername")]
    partial class seedAdminUserChangeUsername
    {
            ...
            modelBuilder.Entity("Shared.Core.Models.ArticlesCategories", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedAt = new DateTime(2019, 2, 9, 17, 38, 47, 823, DateTimeKind.Utc), CreatedBy = "admin", Name = "وصفات الطعام", PredefinedKey = 2, ProfilePicture = "Files/Articles%20Categories/food.png" },
                        new { Id = 2, CreatedAt = new DateTime(2019, 2, 9, 17, 38, 47, 825, DateTimeKind.Utc), CreatedBy = "admin", Name = "الأخبار", PredefinedKey = 1, ProfilePicture = "Files/Articles%20Categories/news.png" }
                    );
                });
            ...
            modelBuilder.Entity("Shared.Core.Models.AspNetRoles", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Id = "785435d0-80ed-4791-bfec-356c29bed814", Name = "Client" },
                        new { Id = "409a759b-edf2-404b-b060-2b50d06bcc14", Name = "RegularUser" },
                        new { Id = "9823bdae-57e2-493e-a08c-fa5962d21d48", Name = "Trainer" },
                        new { Id = "3e6a4e93-9ffc-4223-8fe3-8e1aa2e18fd5", Name = "ArticleWriter" }
                    );
                });
            ...
            modelBuilder.Entity("Shared.Core.Models.AspNetUsers", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "7c654344-ad42-4428-a77a-00a8c1299c3f", AccessFailedCount = 0, Email = "ahmedkabbash@gmail.com", EmailConfirmed = true, FullName = "ahmed kabbash", LockoutEnabled = false, PasswordHash = new byte[] { 190, 24, 6, 76, 49, 166, 37, 187, 183, 24, 246, 14, 202, 8, 25, 234, 118, 47, 151, 75, 176, 45, 8, 137, 140, 208, 10, 255, 249, 165, 217, 9, 46, 66, 14, 214, 20, 219, 230, 176, 33, 201, 199, 147, 72, 110, 40, 55, 126, 81, 17, 228, 70, 22, 175, 117, 198, 188, 160, 208, 254, 98, 73, 41 }, PasswordSalt = new byte[] { 89, 137, 46, 105, 67, 81, 24, 210, 157, 93, 251, 43, 109, 153, 158, 11, 7, 23, 223, 227, 30, 43, 15, 144, 43, 149, 157, 149, 104, 242, 5, 126, 176, 201, 158, 142, 51, 46, 38, 38, 90, 195, 78, 36, 14, 87, 248, 88, 203, 111, 117, 51, 163, 36, 3, 129, 95, 244, 12, 47, 182, 96, 3, 179, 240, 219, 66, 40, 1, 213, 91, 240, 3, 71, 4, 192, 200, 76, 124, 46, 71, 107, 172, 164, 238, 30, 192, 142, 172, 213, 140, 103, 151, 47, 111, 154, 209, 9, 251, 164, 116, 133, 53, 231, 95, 237, 122, 83, 204, 214, 72, 5, 8, 43, 178, 24, 246, 194, 56, 88, 112, 99, 190, 177, 54, 180, 88, 196 }, PhoneNumberConfirmed = false, TwoFactorEnabled = false, UserName = "ahmedkabbash@gmail.com" }
                    );
                });
