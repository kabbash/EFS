...
namespace Trainer.EF.Migrations
{
    ...
    [Migration("20201228231417_Alter_Table_FoodItems_Remove_CaloriesColumn")]
    partial class Alter_Table_FoodItems_Remove_CaloriesColumn
    {
            ...
            modelBuilder.Entity("Shared.Core.Models.ArticlesCategories", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2020, 12, 28, 23, 14, 13, 121, DateTimeKind.Utc).AddTicks(5969),
                            CreatedBy = "admin",
                            Name = "وصفات الطعام",
                            PredefinedKey = 2,
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2020, 12, 28, 23, 14, 13, 125, DateTimeKind.Utc).AddTicks(1972),
                            CreatedBy = "admin",
                            Name = "الأخبار",
                            PredefinedKey = 1,
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2020, 12, 28, 23, 14, 13, 125, DateTimeKind.Utc).AddTicks(2084),
                            CreatedBy = "admin",
                            Name = "البطولات",
                            PredefinedKey = 3,
            ...
            modelBuilder.Entity("Shared.Core.Models.AspNetUsers", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = new byte[] { 107, 90, 32, 53, 65, 241, 9, 145, 99, 23, 146, 103, 52, 120, 41, 78, 71, 137, 29, 199, 193, 242, 167, 131, 66, 9, 118, 140, 124, 22, 108, 67, 82, 39, 175, 30, 22, 78, 22, 182, 230, 159, 130, 203, 78, 130, 63, 165, 188, 77, 22, 242, 232, 255, 55, 56, 242, 119, 239, 100, 201, 221, 90, 1 },
                            PasswordSalt = new byte[] { 240, 158, 108, 78, 8, 212, 229, 80, 120, 40, 250, 170, 27, 239, 109, 207, 13, 157, 63, 245, 86, 73, 139, 214, 48, 41, 135, 220, 166, 49, 138, 168, 170, 2, 96, 38, 223, 31, 52, 157, 213, 181, 177, 145, 224, 136, 94, 191, 47, 227, 166, 16, 231, 156, 130, 2, 88, 77, 127, 228, 230, 203, 173, 16, 93, 145, 72, 211, 156, 207, 85, 209, 87, 81, 45, 228, 117, 146, 57, 113, 137, 39, 147, 176, 171, 58, 180, 56, 145, 112, 7, 209, 17, 99, 156, 72, 4, 110, 25, 163, 123, 206, 252, 44, 20, 105, 37, 209, 226, 97, 86, 14, 17, 199, 20, 97, 91, 181, 151, 215, 133, 40, 206, 130, 70, 151, 205, 49 },
                        ...
                        new
                        {
                            ...
                            IsBlocked = false,
                            LockoutEnabled = false,
                            PasswordHash = new byte[] { 239, 11, 58, 9, 207, 172, 70, 204, 33, 33, 161, 242, 73, 4, 143, 134, 233, 203, 248, 188, 222, 160, 161, 29, 251, 10, 70, 23, 193, 189, 128, 198, 108, 255, 39, 220, 190, 93, 236, 166, 50, 183, 42, 235, 77, 222, 174, 134, 119, 58, 127, 124, 33, 141, 136, 147, 159, 245, 203, 188, 174, 214, 125, 124 },
                            PasswordSalt = new byte[] { 240, 158, 108, 78, 8, 212, 229, 80, 120, 40, 250, 170, 27, 239, 109, 207, 13, 157, 63, 245, 86, 73, 139, 214, 48, 41, 135, 220, 166, 49, 138, 168, 170, 2, 96, 38, 223, 31, 52, 157, 213, 181, 177, 145, 224, 136, 94, 191, 47, 227, 166, 16, 231, 156, 130, 2, 88, 77, 127, 228, 230, 203, 173, 16, 93, 145, 72, 211, 156, 207, 85, 209, 87, 81, 45, 228, 117, 146, 57, 113, 137, 39, 147, 176, 171, 58, 180, 56, 145, 112, 7, 209, 17, 99, 156, 72, 4, 110, 25, 163, 123, 206, 252, 44, 20, 105, 37, 209, 226, 97, 86, 14, 17, 199, 20, 97, 91, 181, 151, 215, 133, 40, 206, 130, 70, 151, 205, 49 },
