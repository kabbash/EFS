            ...
            modelBuilder.Entity("Shared.Core.Models.ArticlesCategories", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedAt = new DateTime(2019, 1, 27, 5, 52, 37, 867, DateTimeKind.Utc), CreatedBy = "admin", Name = "وصفات الطعام", PredefinedKey = 2, ProfilePicture = "Files/Articles%20Categories/food.png" },
                        new { Id = 2, CreatedAt = new DateTime(2019, 1, 27, 5, 52, 37, 871, DateTimeKind.Utc), CreatedBy = "admin", Name = "الأخبار", PredefinedKey = 1, ProfilePicture = "Files/Articles%20Categories/news.png" }
                    );
                });
            ...
            modelBuilder.Entity("Shared.Core.Models.AspNetRoles", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Id = "6ef2128e-77b5-4504-88ee-ef0af3cf9fb6", Name = "Client" },
                        new { Id = "4f6ee453-1696-48b8-949a-5650c848011c", Name = "RegularUser" },
                        new { Id = "5b994d8a-039f-4157-be71-f03532674de5", Name = "Trainer" },
                        new { Id = "1f6a93d5-8769-4479-89cc-1ba7abc20189", Name = "ArticleWriter" }
                    );
                });
