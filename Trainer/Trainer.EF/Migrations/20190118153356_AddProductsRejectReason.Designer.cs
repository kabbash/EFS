...
namespace Trainer.EF.Migrations
{
    ...
    [Migration("20190118153356_AddProductsRejectReason")]
    partial class AddProductsRejectReason
    {
            ...
            modelBuilder.Entity("Shared.Core.Models.ArticlesCategories", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedAt = new DateTime(2019, 1, 18, 15, 33, 55, 109, DateTimeKind.Utc), CreatedBy = "admin", Name = "وصفات الطعام", PredefinedKey = 2, ProfilePicture = "Files/Articles%20Categories/food.png" },
                        new { Id = 2, CreatedAt = new DateTime(2019, 1, 18, 15, 33, 55, 112, DateTimeKind.Utc), CreatedBy = "admin", Name = "الأخبار", PredefinedKey = 1, ProfilePicture = "Files/Articles%20Categories/news.png" }
                    );
                });
            ...
            modelBuilder.Entity("Shared.Core.Models.AspNetRoles", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Id = "782cc0a6-89f9-4b9d-86c6-9314569f9ce1", Name = "Client" },
                        new { Id = "235fdede-204d-46c6-b2a3-9c6b0f775848", Name = "RegularUser" },
                        new { Id = "e1b207e2-ff11-4756-bbfa-4698bc52b734", Name = "Trainer" },
                        new { Id = "32fc0130-ba49-478c-a743-9751396b7f81", Name = "ArticleWriter" }
                    );
                });
