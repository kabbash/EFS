...
namespace Trainer.EF.Migrations
{
    ...
    [Migration("20190210171204_seedAdminUserChangePhoneNumber")]
    partial class seedAdminUserChangePhoneNumber
    {
            ...
            modelBuilder.Entity("Shared.Core.Models.ArticlesCategories", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedAt = new DateTime(2019, 2, 10, 17, 11, 59, 132, DateTimeKind.Utc), CreatedBy = "admin", Name = "وصفات الطعام", PredefinedKey = 2, ProfilePicture = "Files/Articles%20Categories/food.png" },
                        new { Id = 2, CreatedAt = new DateTime(2019, 2, 10, 17, 11, 59, 148, DateTimeKind.Utc), CreatedBy = "admin", Name = "الأخبار", PredefinedKey = 1, ProfilePicture = "Files/Articles%20Categories/news.png" }
                    );
                });
            ...
            modelBuilder.Entity("Shared.Core.Models.AspNetRoles", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Id = "cc0e29fc-00da-4928-bba0-a5b7cb5b76f1", Name = "Client" },
                        new { Id = "2ea64121-406d-4f87-bbb4-343766f48e70", Name = "RegularUser" },
                        new { Id = "00fa336e-8093-4598-b091-de3883cca662", Name = "Trainer" },
                        new { Id = "f2d32601-c378-4f5c-9b91-800aaa5c0892", Name = "ArticleWriter" }
                    );
                });
            ...
            modelBuilder.Entity("Shared.Core.Models.AspNetUsers", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "7c654344-ad42-4428-a77a-00a8c1299c3f", AccessFailedCount = 0, Email = "ahmedkabbash@gmail.com", EmailConfirmed = true, FullName = "ahmed kabbash", LockoutEnabled = false, PasswordHash = new byte[] { 255, 19, 248, 39, 215, 78, 44, 34, 64, 157, 124, 101, 111, 204, 83, 237, 199, 122, 193, 40, 68, 29, 240, 65, 216, 98, 102, 161, 214, 24, 242, 88, 149, 233, 252, 98, 6, 98, 77, 90, 23, 49, 110, 44, 164, 13, 79, 55, 52, 170, 172, 62, 163, 14, 175, 205, 169, 20, 132, 51, 20, 69, 234, 241 }, PasswordSalt = new byte[] { 168, 34, 141, 233, 106, 64, 18, 247, 32, 199, 185, 222, 53, 47, 230, 229, 192, 217, 60, 46, 215, 160, 224, 17, 217, 64, 244, 219, 161, 132, 56, 69, 228, 92, 58, 59, 118, 33, 126, 5, 167, 204, 92, 88, 163, 44, 94, 45, 19, 121, 254, 119, 239, 20, 253, 248, 128, 76, 223, 40, 170, 252, 141, 26, 200, 188, 19, 68, 154, 183, 80, 147, 154, 189, 92, 32, 236, 65, 98, 116, 154, 193, 190, 134, 38, 52, 141, 60, 130, 84, 249, 162, 129, 120, 54, 125, 3, 71, 160, 36, 110, 151, 232, 2, 245, 213, 211, 236, 35, 33, 155, 125, 70, 40, 218, 3, 221, 124, 237, 236, 168, 216, 80, 62, 37, 174, 134, 80 }, PhoneNumber = "01014991554", PhoneNumberConfirmed = false, TwoFactorEnabled = false, UserName = "ahmedkabbash@gmail.com" }
                    );
                });
