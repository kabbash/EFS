...
namespace Trainer.EF.Migrations
{
    ...
    [Migration("20190213193428_AddBannerEntity")]
            ...
            modelBuilder.Entity("Shared.Core.Models.ArticlesCategories", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedAt = new DateTime(2019, 2, 13, 19, 34, 16, 703, DateTimeKind.Utc), CreatedBy = "admin", Name = "وصفات الطعام", PredefinedKey = 2, ProfilePicture = "Files/Articles%20Categories/food.png" },
                        new { Id = 2, CreatedAt = new DateTime(2019, 2, 13, 19, 34, 16, 758, DateTimeKind.Utc), CreatedBy = "admin", Name = "الأخبار", PredefinedKey = 1, ProfilePicture = "Files/Articles%20Categories/news.png" }
                    );
                });
            ...
            modelBuilder.Entity("Shared.Core.Models.AspNetRoles", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Id = "22960cdb-67e6-4f27-8d30-511d0779ee70", Name = "Client" },
                        new { Id = "57d360b8-d4d5-4f53-825c-6df2f1770977", Name = "RegularUser" },
                        new { Id = "6ee7a9ba-79ab-4041-a758-ab7a879d01b4", Name = "Trainer" },
                        new { Id = "0ccca260-6ccf-44ac-905c-0d74012eebe9", Name = "ArticleWriter" }
                    );
                });
            ...
            modelBuilder.Entity("Shared.Core.Models.AspNetUsers", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "7c654344-ad42-4428-a77a-00a8c1299c3f", AccessFailedCount = 0, Email = "ahmedkabbash@gmail.com", EmailConfirmed = true, FullName = "ahmed kabbash", LockoutEnabled = false, PasswordHash = new byte[] { 132, 157, 48, 94, 197, 175, 206, 15, 163, 242, 153, 131, 165, 64, 78, 87, 50, 154, 9, 65, 161, 60, 31, 73, 131, 175, 73, 208, 112, 197, 164, 0, 69, 160, 185, 76, 59, 212, 34, 167, 48, 71, 45, 88, 229, 215, 54, 91, 2, 127, 189, 179, 233, 106, 6, 74, 90, 247, 243, 199, 117, 79, 54, 185 }, PasswordSalt = new byte[] { 191, 1, 158, 242, 122, 27, 241, 55, 99, 1, 249, 156, 119, 22, 166, 80, 153, 101, 131, 199, 237, 142, 182, 224, 60, 79, 234, 151, 176, 194, 154, 145, 41, 218, 171, 155, 204, 43, 79, 62, 58, 46, 131, 158, 242, 92, 145, 11, 119, 238, 80, 217, 146, 56, 204, 192, 228, 225, 117, 39, 255, 95, 151, 163, 183, 145, 216, 147, 134, 163, 106, 15, 188, 241, 38, 106, 37, 79, 253, 250, 24, 249, 147, 180, 159, 66, 202, 140, 186, 249, 209, 64, 114, 85, 244, 235, 188, 172, 106, 131, 239, 161, 51, 132, 124, 116, 37, 138, 3, 254, 8, 82, 213, 251, 255, 40, 181, 34, 238, 56, 81, 88, 32, 107, 93, 104, 31, 208 }, PhoneNumber = "01014991554", PhoneNumberConfirmed = false, TwoFactorEnabled = false, UserName = "ahmedkabbash@gmail.com" }
                    );
                });
