...
namespace Trainer.EF.Migrations
{
    ...
    [Migration("20190124115124_SliderEntitiesEdit")]
    partial class SliderEntitiesEdit
    {
            ...
            modelBuilder.Entity("Shared.Core.Models.ArticlesCategories", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedAt = new DateTime(2019, 1, 24, 11, 51, 21, 917, DateTimeKind.Utc), CreatedBy = "admin", Name = "وصفات الطعام", PredefinedKey = 2, ProfilePicture = "Files/Articles%20Categories/food.png" },
                        new { Id = 2, CreatedAt = new DateTime(2019, 1, 24, 11, 51, 21, 922, DateTimeKind.Utc), CreatedBy = "admin", Name = "الأخبار", PredefinedKey = 1, ProfilePicture = "Files/Articles%20Categories/news.png" }
                    );
                });
            ...
            modelBuilder.Entity("Shared.Core.Models.AspNetRoles", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Id = "c478e23e-b1f5-4f43-90da-e0a3036a3efe", Name = "Client" },
                        new { Id = "eda5c1de-fa0c-4bc5-80e2-bc0b3ef79e5f", Name = "RegularUser" },
                        new { Id = "dd07ee20-c827-4513-bab1-041f54469eab", Name = "Trainer" },
                        new { Id = "e3a41851-4edd-4175-a70b-e281a998510d", Name = "ArticleWriter" }
                    );
                });
