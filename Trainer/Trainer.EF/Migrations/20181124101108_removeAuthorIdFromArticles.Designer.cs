...
namespace Trainer.EF.Migrations
{
    ...
    [Migration("20181124101108_removeAuthorIdFromArticles")]
    partial class removeAuthorIdFromArticles
    {
            ...
            modelBuilder.Entity("Shared.Core.Models.AspNetRoles", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Id = "7bc144ee-0c0f-4be4-a9fb-88504fe83f71", Name = "Client" },
                        new { Id = "af7edf6b-13de-4958-97c0-8bbce5594c87", Name = "ProductOwner" },
                        new { Id = "ac3bd65b-dcc0-4a39-bcac-cd4324e3437d", Name = "RegularUser" },
                        new { Id = "9f789b13-865a-4715-9fd6-7f270a57fbf5", Name = "Trainer" },
                        new { Id = "423d3428-373e-4c7a-be3c-5dc932b63cef", Name = "ArticleWriter" }
                    );
                });
