...
namespace Trainer.EF.Migrations
{
    ...
    [Migration("20190112113428_AddRejectionReasonInArticles")]
    partial class AddRejectionReasonInArticles
    {
            ...
            modelBuilder.Entity("Shared.Core.Models.ArticlesCategories", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedAt = new DateTime(2019, 1, 12, 11, 34, 24, 9, DateTimeKind.Utc), CreatedBy = "admin", Name = "وصفات الطعام", PredefinedKey = 2, ProfilePicture = "Files/Articles%20Categories/food.png" },
                        new { Id = 2, CreatedAt = new DateTime(2019, 1, 12, 11, 34, 24, 41, DateTimeKind.Utc), CreatedBy = "admin", Name = "الأخبار", PredefinedKey = 1, ProfilePicture = "Files/Articles%20Categories/news.png" }
                    );
                });
            ...
            modelBuilder.Entity("Shared.Core.Models.AspNetRoles", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Id = "57ff8bc7-860e-4436-b50d-1b1052bab4e0", Name = "Client" },
                        new { Id = "ff9eecba-da67-4049-92e4-e9253f74bcaf", Name = "RegularUser" },
                        new { Id = "694b82c4-21d0-4406-a010-984562d47631", Name = "Trainer" },
                        new { Id = "c6cb885e-a9f1-4b78-97f1-3fec72aa2982", Name = "ArticleWriter" }
                    );
                });
